...
class VirtualBackgroundService {
     ...
     */
     runPostProcessing() {
        onResults({image:this._videoShotCanvas,segmentationMask:this._segmentationMaskCanvas})
		/*
		...
		*/
		//canvasElement=document.getElementsByClassName('output_canvas2')[0];
		// var canvasCtx=canvasElement.getContext('2d')
		// canvasCtx.clearRect(0, 0, canvasElement.width, canvasElement.height);
		// canvasCtx.drawImage(this._outputCanvasElement, 0, 0);
    ...
    _renderMask() {
        try {
            this._videoShotCtx.drawImage(this._inputVideoElement, 0, 0);
			this.resizeSource();
            this.runInference();
     ...
     */
    startEffect(stream) {
        this._videoShotCanvas = document.createElement('canvas');

		this._videoShotCtx = this._videoShotCanvas.getContext('2d');
		...
		this._videoShotCanvas.width=width;
		this._videoShotCanvas.height=height;
     ...
     */
async function createVirtualBackgroundService(parameters = null) {
    let tflite;
    let modelResponse;
